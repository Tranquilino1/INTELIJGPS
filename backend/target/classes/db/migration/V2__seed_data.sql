...
-- ─── BATA (Región Continental – Litoral) ─────────────────────────────────
INSERT INTO cultural_landmarks (name, alias, category, city, region, geom, address_hint, importance, is_verified, source) VALUES
...
('Mercado Central de Bata',            ARRAY['mercado central', 'mundoasi'],                 'mercado',     'Bata', 'Litoral', ST_SetSRID(ST_MakePoint(9.7670, 1.8630), 4326), 'Barrio Centro, Bata', 10, TRUE, 'field_survey');
...
('trafico_pesado', 2, ST_SetSRID(ST_MakePoint(8.7880, 3.7475), 4326), 'Zona Puerto Malabo', 'Tráfico pesado por carga de contenedores', 5, TRUE, NOW() + INTERVAL '4 hours'),
('corte_lluvia',   3, ST_SetSRID(ST_MakePoint(9.7640, 1.8610), 4326), 'Carretera Bata-Mbini', 'Corte total por lluvias fuertes. Use ruta alternativa.', 12, TRUE, NOW() + INTERVAL '2 hours');
